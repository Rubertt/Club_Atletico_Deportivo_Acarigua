        ...
        <?php else: foreach ($eventos as $ev): ?>
            <div class="sesion-row-card sesion-row">
                ...
                <div class="sesion-row-card__actions">
                    <a href="<?= e(url('/admin/resultados-pruebas/sesion/' . $ev['evento_id'])) ?>" class="btn btn-sm btn-ghost" title="Ver Detalles">
                        <i class="ph ph-eye"></i>
                    </a>
                    <a href="<?= e(url('/admin/resultados-pruebas/sesion/' . $ev['evento_id'] . '/editar')) ?>" class="btn btn-sm btn-outline" title="Editar">
                        <i class="ph ph-pencil-simple"></i>
                    </a>
                    <form action="<?= e(url('/admin/resultados-pruebas/sesion/' . $ev['evento_id'] . '/eliminar')) ?>" method="POST" style="display:inline;">
                        <?= csrf_field() ?>
                        <button type="button" class="btn btn-sm btn-outline btn-delete-sesion" title="Eliminar Registro" data-date="<?= e(date('d/m/Y', strtotime($ev['fecha_evento']))) ?>">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function initClientPagination() {
        ...
        const rows = Array.from(document.querySelectorAll('.sesion-row'));
        const totalCount = rows.length;
        const container = document.getElementById('sesiones-pagination');
